($(function () {
  ...
  $(t).submit(function (e) {
    e.preventDefault();
    e = $(t).serialize();
    $.ajax({ type: "POST", url: $(t).attr("action"), data: e })
      .done(function (e) {
        ($(i).removeClass("error"),
          $(i).addClass("success"),
          $(i).text(e),
        ...
        [
                ...
                return !0 === (e = v.disable) ||
                  ...
                  : (document
                    ...
                    window.addEventListener(
                      "resize",
                      (0, d.default)(s, v.debounceDelay, !0),
                    ),
                    window.addEventListener(
                      "orientationchange",
                      (0, d.default)(s, v.debounceDelay, !0),
              ...
              return (
                e.forEach(function (e, t) {
                  (e.node.classList.add("aos-init"),
                    (e.position = (0, o.default)(e.node, i.offset)));
                }),
                e
              );
            };
          ...
          function (e, t, i) {
            ...
            t.default = function (e, t) {
              ...
              return (
                i + (n = !(o.anchorPlacement || o.offset || isNaN(t)) ? t : n)
              );
            };
          },
          function (e, t) {
  ...
  (function (t, i) {
    ...
    function a(e, t, i) {
      ...
      var n,
        s = e;
      return (s = "string" == typeof e ? document.querySelectorAll(e) : s)
        ? ((this.elements =
            ((n = s),
            Array.isArray(n)
              ? n
      ...
      (a.prototype.addElementImages = function (e) {
        ...
        if (t && u[t]) {
          ...
          if ("string" == typeof this.options.background)
            for (
              var o = e.querySelectorAll(this.options.background), n = 0;
              n < o.length;
              n++
            ) {
              var a = o[n];
        ...
        (u.fn[l] = function (e) {
          ...
          return (
            ...
            (e = this).each(function (e, t) {
              ...
              i
                ? (t = i[n]) && "_" != n.charAt(0)
                  ? ((i = t.apply(i, s)), (o = void 0 === o ? i : o))
                  : p(a + " is not a valid method")
                : p(l + " not initialized. Cannot call methods, i.e. " + a);
            }),
            void 0 !== o ? o : e
          );
        }),
    ...
    function f(e) {
      if (
        (b ||
          ...
          (c = document.body || document.documentElement).appendChild(p),
          (u = m(p)),
          (g = 200 == Math.round(h(u.width))),
          (f.isBoxSizeOuter = g),
          c.removeChild(p)),
        ...
        for (
          var n = (i.isBorderBox = "border-box" == t.boxSizing), s = 0;
          s < y;
          s++
        ) {
          var o = v[s],
        ...
        n = h(t.height);
        return (
          !1 !== n && (i.height = n + (e ? 0 : l + p)),
          (i.innerWidth = i.width - (r + c)),
    ...
    ((e.constructor = i),
      ...
      (e.getPosition = function () {
        var e = getComputedStyle(this.element),
          ...
          a = parseFloat(s),
          e = this.layout.size;
        (-1 != n.indexOf("%") && (o = (o / 100) * e.width),
          -1 != s.indexOf("%") && (a = (a / 100) * e.height),
          (o = isNaN(o) ? 0 : o),
          (a = isNaN(a) ? 0 : a),
          (o -= t ? e.paddingLeft : e.paddingRight),
          (a -= i ? e.paddingTop : e.paddingBottom),
          (this.position.x = o),
          (this.position.y = a));
      }),
      (e.layoutPosition = function () {
        ...
        ((s = n ? "bottom" : "top"),
          (e = this.position.y + e[n ? "paddingTop" : "paddingBottom"]));
        ((t[n ? "top" : "bottom"] = this.getYValue(e)),
          (t[s] = ""),
          this.css(t),
      ...
      (e._transitionTo = function (e, t) {
        ...
        (this.setPosition(e, t),
          !s || this.isTransitioning
            ? (((s = {}).transform = this.getTranslate(e - i, t - n)),
              this.transition({
                to: s,
      ...
      (p.dispatchEvent = function (e, t, i) {
        ...
        (this.emitEvent(e, n),
          d &&
            ...
            t
              ? (((t = d.Event(t)).type = e), this.$element.trigger(t, i))
    ...
    return (
      ...
      (s.getSegmentSize = function (e, t) {
        ...
        (this._getMeasurement(i, n),
          this[i] ||
            ((e = this.getFirstItemSize()),
            (this[i] = (e && e[n]) || this.isotope.size["inner" + t])));
      }),
      ...
      (e.measureColumns = function () {
        (this.getContainerWidth(),
          this.columnWidth ||
            ...
            (this.columnWidth =
              (i && r(i).outerWidth) || this.containerWidth)));
      ...
      (e._manageStamp = function (e) {
        ...
        for (
          var s = Math.min(this.cols - 1, s),
            o =
              (this._getOption("originTop") ? i.top : i.bottom) + t.outerHeight,
            a = n;
          a <= s;
          a++
        )
  ...
  (function (a, r) {
    ...
    ((s._create = function () {
      ...
      (s._filter = function (e) {
        for (
          ...
          l.isIgnored ||
            ((r = o(l)) && i.push(l),
            r && l.isHidden ? n.push(l) : r || l.isHidden || s.push(l));
        }
    ...
    ((d.sortDataParsers = {
      ...
      (s.insert = function (e) {
        ...
        if (t.length) {
          for (var i, n = t.length, s = 0; s < n; s++)
    ...
    !(function () {
      ...
      ((t.prototype.init = function () {
        ...
        (t.prototype.setTop = function () {
          var e, t, i;
          "100%" !== this.s.height &&
            ((t = ((e = p(window).height()) - parseInt(this.s.height, 10)) / 2),
        ...
        (t.prototype.loadContent = function (t, e, i) {
          var r,
            ...
            u = a.s.dynamic
              ? (a.s.dynamicEl[t].poster &&
                  ((l = !0), (n = a.s.dynamicEl[t].poster)),
                (o = a.s.dynamicEl[t].html),
                (r = a.s.dynamicEl[t].src),
                a.s.dynamicEl[t].responsive &&
                  d(a.s.dynamicEl[t].responsive.split(",")),
                (s = a.s.dynamicEl[t].srcset),
                a.s.dynamicEl[t].sizes)
              : (a.$items.eq(t).attr("data-poster") &&
                  ((l = !0), (n = a.$items.eq(t).attr("data-poster"))),
                (o = a.$items.eq(t).attr("data-html")),
                (r =
                  a.$items.eq(t).attr("href") ||
                  a.$items.eq(t).attr("data-src")),
                a.$items.eq(t).attr("data-responsive") &&
                  d(a.$items.eq(t).attr("data-responsive").split(",")),
                (s = a.$items.eq(t).attr("data-srcset")),
                a.$items.eq(t).attr("data-sizes")),
            c = !1;
          a.s.dynamic
            ? a.s.dynamicEl[t].iframe && (c = !0)
            : "true" === a.$items.eq(t).attr("data-iframe") && (c = !0);
          d = a.isVideo(r, t);
          if (!a.$slide.eq(t).hasClass("lg-loaded")) {
            if (
                ...
                : l
                  ...
                  : d
                    ? (a.$slide
                      ...
                      a.$el.trigger("hasVideo.lg", [t, r, o]))
                    : a.$slide
                        .eq(t)
                        .prepend(
              ...
              a.$el.trigger("onAferAppendSlide.lg", [t]),
              (o = a.$slide.eq(t).find(".lg-object")),
              u && o.attr("sizes", u),
              s)
            ) {
              o.attr("srcset", s);
            ...
            (".lg-sub-html" !== this.s.appendSubHtmlTo && a.addHtml(t),
              a.$slide.eq(t).addClass("lg-loaded"));
          }
          (a.$slide
            .eq(t)
            .find(".lg-object")
            .on("load.lg error.lg", function () {
              var e = 0;
              (i && !p("body").hasClass("lg-from-hash") && (e = i),
                setTimeout(function () {
                  (a.$slide.eq(t).addClass("lg-complete"),
                    a.$el.trigger("onSlideItemLoad.lg", [t, i || 0]));
                }, e));
            }),
            d && d.html5 && !l && a.$slide.eq(t).addClass("lg-complete"),
            !0 === e &&
              (a.$slide.eq(t).hasClass("lg-complete")
                ? a.preload(t)
                : a.$slide
                    .eq(t)
                    .find(".lg-object")
            ...
            u.lgBusy ||
              ...
              t
                ? (this.$slide.removeClass(
                  ...
                  "prev" === n
                    ...
                    : u.$slide.eq(r).addClass("lg-prev-slide"),
                ...
                : (u.$outer.addClass("lg-no-trans"),
                  ...
                  "prev" === n
                    ...
                    : (this.$slide.eq(e).addClass("lg-next-slide"),
                      this.$slide.eq(d).addClass("lg-prev-slide")),
                  setTimeout(function () {
              ...
              u.lGalleryOn
                ? (setTimeout(function () {
                  ...
                  setTimeout(function () {
                    ((u.lgBusy = !1),
                      u.$el.trigger("onAfterSlide.lg", [d, e, t, i]));
                  }, this.s.speed))
        ...
        (t.prototype.touchMove = function (e, t) {
          ...
          15 < Math.abs(e) &&
            ...
            this.setTranslate(
              p(".lg-prev-slide"),
              -this.$slide.eq(this.index).width() + e,
              0,
            ),
            this.setTranslate(
              p(".lg-next-slide"),
  ...
  (function (e) {
    ...
    !(function () {
      ...
      function e(e) {
        return (
          (this.core = l(e).data("lightGallery")),
          (this.$el = l(e)),
          (this.core.s = l.extend({}, t, this.core.s)),
          (this.videoLoaded = !1),
          this.init(),
          this
        );
      ...
      ((e.prototype.init = function () {
          ...
          function (e, t, i, n) {
            ...
            if (
              (s.core.$slide
                .eq(t)
                .find(".lg-video")
                .append(s.loadVideo(i, "lg-object", !0, t, n)),
              n)
            )
              if (s.core.s.videojs)
                try {
                  videojs(
                    s.core.$slide.eq(t).find(".lg-html5").get(0),
                ...
                !s.videoLoaded &&
                  s.core.s.autoplayFirstVideo &&
                  s.core.$slide.eq(t).find(".lg-html5").get(0).play();
          }.bind(this),
        ),
          i.core.$el.on(
            ...
            function (e, t) {
              ...
              t.hasClass("lg-has-iframe") ||
                (t.css("max-width", this.core.s.videoMaxWidth),
                (this.videoLoaded = !0));
            }.bind(this),
          ),
          i.core.doCss() &&
          ...
          i.core.$el.on(
            ...
            function (e, t, i) {
              ...
              t &&
                l(t).attr(
                  "src",
                  l(t).attr("src").replace("&autoplay", "&noplay"),
                );
              t = n.core.s.dynamic
                ? n.core.s.dynamicEl[i].src
                : n.core.$items.eq(i).attr("href") ||
                  n.core.$items.eq(i).attr("data-src");
        ...
        (e.prototype.loadVideo = function (e, t, i, n, s) {
          ...
          return (
            ...
            n.youtube
              ? ((r = "?wmode=opaque&autoplay=" + a + "&enablejsapi=1"),
              ...
              : n.vimeo
                ? ((r = "?autoplay=" + a + "&api=1"),
                  this.core.s.vimeoPlayerParams &&
                    (r = r + "&" + l.param(this.core.s.vimeoPlayerParams)),
                  (o =
                ...
                : n.dailymotion
                  ? ((r = "?wmode=opaque&autoplay=" + a + "&api=postMessage"),
                    this.core.s.dailymotionPlayerParams &&
                      (r =
                        r + "&" + l.param(this.core.s.dailymotionPlayerParams)),
                    (o =
                  ...
                  : n.html5
                    ...
                    : n.vk &&
                      ...
                      this.core.s.vkPlayerParams &&
                        (r = r + "&" + l.param(this.core.s.vkPlayerParams)),
                      (o =
            ...
            if (i.hasClass("lg-has-video")) {
              ...
              o = function (e, t) {
                if (
                  (i
                    .find(".lg-video")
                    .append(n.loadVideo(e, "", !1, n.core.index, t)),
                  t)
                )
                  if (n.core.s.videojs)
                    try {
              ...
              n.core.s.dynamic
                ? o(
                    n.core.s.dynamicEl[n.core.index].src,
                    n.core.s.dynamicEl[n.core.index].html,
                  )
                : o(
  ...
  (function (e, t) {
    ...
    !(function () {
      ...
      function e(e) {
        return (
          (this.core = n(e).data("lightGallery")),
          (this.$el = n(e)),
    ...
    !(function () {
      ...
      function e(e) {
        return (
          ...
          (this.core.s = u.extend({}, n, this.core.s)),
          this.core.s.zoom &&
            this.core.doCss() &&
            (this.init(),
      ...
      ((e.prototype.init = function () {
        ...
        (o.core.s.actualSize &&
          ...
          o.core.$el.on("onSlideItemLoad.lg.tm.zoom", function (e, t, i) {
        ...
        function t(e) {
          ...
          (t
            ...
            .attr("data-scale", e),
            (o.core.s.useLeftForZoom
              ? t.parent().css({ left: -i + "px", top: -n + "px" })
              : t
                  .parent()
                  .css(
                    "transform",
        ...
        function n(e, t, i, n) {
          var s = t.prop("offsetWidth"),
            t = o.core.s.dynamic
              ? o.core.s.dynamicEl[i].width || t[0].naturalWidth || s
          ...
          (o.core.$outer.hasClass("lg-zoomed")
            ...
            n
              ...
              : ((o.pageX = e.pageX || e.originalEvent.targetTouches[0].pageX),
                (o.pageY = e.pageY || e.originalEvent.targetTouches[0].pageY)),
            a(),
            setTimeout(function () {
        ...
        (e.prototype.zoomSwipe = function () {
          ...
          (n.core.$slide.on("touchstart.lg", function (e) {
            ...
            n.core.$outer.hasClass("lg-zoomed") &&
              ((t = n.core.$slide.eq(n.core.index).find(".lg-object")),
              (l =
            ...
            n.core.$slide.on("touchmove.lg", function (e) {
              ...
              n.core.$outer.hasClass("lg-zoomed") &&
                ...
                (t = l
                  ? -Math.abs(i.attr("data-y")) + (o.y - s.y)
                  : -Math.abs(i.attr("data-y"))),
                (e = r
                  ? -Math.abs(i.attr("data-x")) + (o.x - s.x)
                  : -Math.abs(i.attr("data-x"))),
                (15 < Math.abs(o.x - s.x) || 15 < Math.abs(o.y - s.y)) &&
                  (n.core.s.useLeftForZoom
                    ? i.css({ left: e + "px", top: t + "px" })
                    : i.css(
                        "transform",
        ...
        (e.prototype.touchendZoom = function (e, t, i, n) {
          var s = this,
            ...
            d =
              (s.core.$outer.find(".lg").height() - a.prop("offsetHeight")) / 2,
            u = Math.abs(
              a.prop("offsetHeight") * Math.abs(a.attr("data-scale")) -
                s.core.$outer.find(".lg").height() +
                d,
            ),
            c = (s.core.$outer.find(".lg").width() - a.prop("offsetWidth")) / 2,
            a = Math.abs(
              a.prop("offsetWidth") * Math.abs(a.attr("data-scale")) -
          ...
          (15 < Math.abs(t.x - e.x) || 15 < Math.abs(t.y - e.y)) &&
            ...
            i
              ? o.attr("data-x", Math.abs(r))
              : (r = -Math.abs(o.attr("data-x"))),
            s.core.s.useLeftForZoom
              ? o.css({ left: r + "px", top: l + "px" })
  ...
  (function (e) {
    ...
    !(function () {
      ...
      function e(e) {
        return (
          (this.core = s(e).data("lightGallery")),
          (this.core.s = s.extend({}, t, this.core.s)),
      ...
      ((e.prototype.init = function () {
            ...
            setTimeout(function () {
              (s("#lg-share-facebook").attr(
                ...
                "https://www.facebook.com/sharer/sharer.php?u=" +
                  encodeURIComponent(
                    n.getSahreProps(i, "facebookShareUrl") ||
                ...
                s("#lg-share-twitter").attr(
                  ...
                  "https://twitter.com/intent/tweet?text=" +
                    ...
                    "&url=" +
                    encodeURIComponent(
                      n.getSahreProps(i, "twitterShareUrl") ||
                        window.location.href,
                    ),
                ),
                s("#lg-share-googleplus").attr(
                  ...
                  "https://plus.google.com/share?url=" +
                    encodeURIComponent(
                      n.getSahreProps(i, "googleplusShareUrl") ||
                        window.location.href,
                    ),
                ),
                s("#lg-share-pinterest").attr(
                  ...
                  "http://www.pinterest.com/pin/create/button/?url=" +
                    encodeURIComponent(
                      n.getSahreProps(i, "pinterestShareUrl") ||
                        window.location.href,
                    ) +
                    "&media=" +
        ...
        (e.prototype.getSahreProps = function (e, t) {
          ...
          return this.core.s.dynamic
            ? this.core.s.dynamicEl[e][t]
            : ((i = this.core.$items.eq(e).attr("href")),
              (e = this.core.$items.eq(e).data(t)),
              ("src" === t && i) || e);
        }),
        (e.prototype.destroy = function () {}),
        (s.fn.lightGallery.modules.share = e));
    })();
  }),
  (function (t, i) {
    "function" == typeof define && define.amd
  ...
  (function (e, t) {
    ...
    var u,
      c =
        ((u = d(Array)),
        (D = u),
        ((A = p).prototype = Object.create(D.prototype)),
        ((A.prototype.constructor = A).__proto__ = D),
        p);
    function p(e) {
      ...
      if ("string" == typeof e) {
        ...
        if (0 <= n.indexOf("<") && 0 <= n.indexOf(">")) {
          ...
          i = (function (e) {
            if ("string" != typeof e) return [e];
            for (
              var t = [], i = (s || o).querySelectorAll(e), n = 0;
              n < i.length;
              n += 1
            )
              t.push(i[n]);
    ...
    var f,
      ...
      g = {
        ...
        on: function () {
          ...
          "function" == typeof t[1] &&
            ((n = t[0]), (a = t[1]), (s = t[2]), (o = void 0));
          for (
            var d, s = s || !1, u = n.split(" "), c = 0;
            c < this.length;
            c += 1
          ) {
            var p = this[c];
            if (o)
              ...
              for (d = 0; d < u.length; d += 1) {
                ...
                (p.dom7Listeners || (p.dom7Listeners = {}),
                  ...
                  p.dom7Listeners[m].push({ listener: a, proxyListener: l }),
          ...
          for (var a = a || !1, r = n.split(" "), l = 0; l < r.length; l += 1)
            for (var d = r[l], u = 0; u < this.length; u += 1) {
              ...
              if (
                (!s && c.dom7Listeners
                  ? (p = c.dom7Listeners[d])
                  : s && c.dom7LiveListeners && (p = c.dom7LiveListeners[d]),
                p && p.length)
              )
                for (var h = p.length - 1; 0 <= h; --h) {
                  ...
                  (!(
                    ...
                    (o &&
                      ...
                      m.listener.dom7proxy === o)
                  ) &&
                    o) ||
                    (c.removeEventListener(d, m.proxyListener, a),
                    p.splice(h, 1));
                }
            }
          return this;
        ...
        trigger: function () {
          for (
            var e = w(), t = arguments.length, i = new Array(t), n = 0;
            n < t;
            n++
          )
            i[n] = arguments[n];
        ...
        offset: function () {
          if (0 < this.length) {
            ...
            return { top: n.top + s - o, left: n.left + i - t };
          }
          return null;
        },
        css: function (e, t) {
        ...
        parents: function (e) {
          for (var t = [], i = 0; i < this.length; i += 1)
            for (var n = this[i].parentNode; n; )
              ((e && !C(n).is(e)) || t.push(n), (n = n.parentNode));
          return C(t);
        },
        closest: function (e) {
          var t = this;
    ...
    function v(e, t) {
      ...
      var i,
        ...
        a =
          ...
          (a =
            (a =
              !(a = e.getComputedStyle ? e.getComputedStyle(o, null) : a) &&
              o.currentStyle
                ? o.currentStyle
                : a) || o.style));
      return (
          ...
          for (
            ...
            void 0 !== d &&
              ...
              (y(t[l]) && y(s[l])
                ...
                : !y(t[l]) && y(s[l])
                  ? ((t[l] = {}),
                    s[l].__swiper__ ? (t[l] = s[l]) : V(t[l], s[l]))
                  : (t[l] = s[l]));
          }
      }
      return t;
    ...
    Object.keys(g).forEach(function (e) {
      Object.defineProperty(C.fn, e, { value: g[e], writable: !0 });
    });
    var k = {
        name: "resize",
        create: function () {
            ...
            resize: {
              ...
              createObserver: function () {
                o &&
                  !o.destroyed &&
                  o.initialized &&
                  ((o.resize.observer = new ResizeObserver(function (e) {
                    var t = o.width,
                      i = o.height,
                      n = t,
                      s = i;
              ...
              removeObserver: function () {
                o.resize.observer &&
                  o.resize.observer.unobserve &&
                  o.el &&
                  (o.resize.observer.unobserve(o.el),
              ...
              resizeHandler: function () {
                o &&
                  !o.destroyed &&
                  o.initialized &&
                  (o.emit("beforeResize"), o.emit("resize"));
              },
              orientationChangeHandler: function () {
                o &&
                  !o.destroyed &&
                  o.initialized &&
                  o.emit("orientationchange");
              },
            },
          });
        },
    ...
    var A,
      ...
      W = {
            ...
            return (
              (n =
                "string" == typeof o[0] || Array.isArray(o[0])
                  ? ((e = o[0]), (i = o.slice(1, o.length)), s)
                  : ((e = o[0].events), (i = o[0].data), o[0].context || s)),
              i.unshift(n),
        ...
        update: {
            ...
            if (void 0 !== o) {
              ("string" == typeof b &&
                ...
                1 < n.slidesPerColumn &&
                  ...
                  "auto" !== n.slidesPerView &&
                    ...
                    (v = Math.max(v, n.slidesPerView * n.slidesPerColumn))));
              for (
                var T,
                  C,
                  S,
                  ...
                  $ = n.slidesPerColumn,
                  k = v / $,
                  I = Math.floor(c / n.slidesPerColumn),
                  L = 0;
                L < c;
                L += 1
              ) {
                ...
                (1 < n.slidesPerColumn &&
                  ...
                  "row" === n.slidesPerColumnFill && 1 < n.slidesPerGroup
                    ? ((D = Math.floor(
                      ...
                      (O = L - n.slidesPerColumn * n.slidesPerGroup * D),
                      (A =
                        0 === D
                          ? n.slidesPerGroup
                          : Math.min(
                              Math.ceil((c - D * $ * n.slidesPerGroup) / $),
                              n.slidesPerGroup,
                            )),
                      (j =
                        (q =
                  ...
                  "none" !== N.css("display") &&
                    ("auto" === n.slidesPerView
                      ? ((W = getComputedStyle(N[0])),
                        (_ = N[0].style.transform),
                        (P = N[0].style.webkitTransform),
                        _ && (N[0].style.transform = "none"),
                        ...
                        (H = n.roundLengths
                          ...
                          : ((O = e(W, "width")),
                            ...
                            (j = e(W, "margin-left")),
                            (q = e(W, "margin-right")),
                            (B = W.getPropertyValue("box-sizing")) &&
                            "border-box" === B
                              ? O + j + q
                              : ((B = (W = N[0]).clientWidth),
                                O + A + D + j + q + (W.offsetWidth - B)))),
                      ...
                      : ((H =
                        ...
                        n.roundLengths && (H = Math.floor(H)),
                        u[L] && (u[L].style[i("width")] = H + "px")),
                    u[L] && (u[L].swiperSlideSize = H),
                    m.push(H),
                    n.centeredSlides
                      ? ((w = w + H / 2 + x / 2 + b),
                        0 === x && 0 !== L && (w = w - o / 2 - b),
              ...
              if (
                ...
                n.setWrapperSize &&
                  s.css(
                    (((r = {})[i("width")] =
                      t.virtualSize + n.spaceBetween + "px"),
                    r),
                  ),
                1 < n.slidesPerColumn &&
                  ((t.virtualSize = (H + n.spaceBetween) * v),
                  (t.virtualSize =
                ...
                for (var R = [], G = 0; G < p.length; G += 1) {
                  ...
                  (n.roundLengths && (F = Math.floor(F)),
                    p[G] < t.virtualSize + p[0] && R.push(F));
                }
                p = R;
              }
              if (!n.centeredSlides) {
                ...
                for (var Y = 0; Y < p.length; Y += 1) {
                  ...
                  (n.roundLengths && (X = Math.floor(X)),
                    p[Y] <= t.virtualSize - o && R.push(X));
                }
                ((p = R),
                  1 <
                    Math.floor(t.virtualSize - o) -
                      Math.floor(p[p.length - 1]) && p.push(t.virtualSize - o));
              }
              (0 === p.length && (p = [0]),
                0 !== n.spaceBetween &&
                  ((T =
                    t.isHorizontal() && a ? "marginLeft" : i("marginRight")),
                  u
                    .filter(function (e, t) {
          ...
          updateAutoHeight: function (e) {
            ...
            for (t = 0; t < s.length; t += 1)
              void 0 !== s[t] && (o = o < (i = s[t].offsetHeight) ? i : o);
                ...
                var r,
                  ...
                  u =
                    (o +
                      ...
                      d.swiperSlideOffset) /
                    (d.swiperSlideSize + i.spaceBetween);
                ((i.watchSlidesVisibility ||
                  (i.centeredSlides && i.autoHeight)) &&
                  ((l =
                    (r = -(o - d.swiperSlideOffset)) + t.slidesSizesGrid[a]),
                  ((0 <= r && r < t.size - 1) ||
                    (1 < l && l <= t.size) ||
                    (r <= 0 && l >= t.size)) &&
          ...
          updateProgress: function (e) {
            ...
            (V(t, { progress: s, isBeginning: o, isEnd: l }),
          ...
          updateActiveIndex: function (e) {
            ...
            ((o =
              0 <= s.indexOf(i)
                ? s.indexOf(i)
                : (e = Math.min(o.slidesPerGroupSkip, d)) +
                  Math.floor((d - e) / o.slidesPerGroup)) >= s.length &&
              (o = s.length - 1),
              d !== a
                ? ((s = parseInt(
            ...
            (i.isHorizontal() ? (l = n ? -e : e) : (d = e),
              ...
              s.cssMode
                ? (a[i.isHorizontal() ? "scrollLeft" : "scrollTop"] =
                    i.isHorizontal() ? -l : -d)
                : s.virtualTranslate ||
                  o.transform("translate3d(" + l + "px, " + d + "px, 0px)"),
        ...
        slide: {
          slideTo: function (e, t, i, n) {
            ...
            ((e = Math.min(o.params.slidesPerGroupSkip, a)),
              (e += Math.floor((a - e) / o.params.slidesPerGroup)));
            (e >= l.length && (e = l.length - 1),
              (c || r.initialSlide || 0) === (u || 0) &&
                i &&
            ...
            if (
              ...
              return (
                ...
                "slide" !== r.effect && o.setTranslate(m),
                "reset" != h &&
                  (o.transitionStart(i, h), o.transitionEnd(i, h)),
                !1
              );
            if (r.cssMode) {
              ((c = o.isHorizontal()), (r = -m));
              return (
                p && (r = s.scrollWidth - s.offsetWidth - r),
                0 !== t && s.scrollTo
                  ? s.scrollTo(
                      (((p = {})[c ? "left" : "top"] = r),
                      (p.behavior = "smooth"),
          ...
          slidePrev: function (e, t, i) {
            ...
            return (
              ...
              void 0 !== p && (c = r.indexOf(p)) < 0 && (c = n.activeIndex - 1),
              n.slideTo(c, e, t, i)
            );
          },
          ...
          slideToClosest: function (e, t, i, n) {
            ...
            return (
              l >= s.snapGrid[r]
                ? l - (a = s.snapGrid[r]) > (s.snapGrid[r + 1] - a) * n &&
                  (o += s.params.slidesPerGroup)
                : l - (l = s.snapGrid[r - 1]) <= (s.snapGrid[r] - l) * n &&
                  (o -= s.params.slidesPerGroup),
              (o = Math.max(o, 0)),
          ...
          loopCreate: function () {
            ...
            if (t.loopFillGroupWithBlank) {
              ...
              if (o !== t.slidesPerGroup) {
                for (var a = 0; a < o; a += 1) {
                  var r = C(e.createElement("div")).addClass(
            ...
            s.each(function (e, t) {
              var i = C(e);
              (t < n.loopedSlides && d.push(e),
                t < s.length && t >= s.length - n.loopedSlides && l.push(e),
                i.attr("data-swiper-slide-index", t));
            });
            for (var u = 0; u < d.length; u += 1)
              i.append(C(d[u].cloneNode(!0)).addClass(t.slideDuplicateClass));
            for (var c = l.length - 1; 0 <= c; --c)
              i.prepend(C(l[c].cloneNode(!0)).addClass(t.slideDuplicateClass));
          },
          loopFix: function () {
            var e = this;
            ...
            (i < s
              ? ((t = n.length - 3 * s + i),
                e.slideTo((t += s), 0, !1, !0) &&
                  0 != r &&
                  e.setTranslate((l ? -e.translate : e.translate) - r))
              : i >= n.length - s &&
                ((t = -n.length + i + s),
                e.slideTo((t += s), 0, !1, !0) &&
                  0 != r &&
        ...
        manipulation: {
          ...
          removeSlide: function (e) {
            ...
            if ("object" == typeof e && "length" in e) {
              ...
              (t.slides[(o = e)] && t.slides.eq(o).remove(),
                o < a && --a,
                (a = Math.max(a, 0)));
            (i.loop && t.loopCreate(),
              (i.observer && t.support.observer) || t.update(),
          ...
          attachEvents: function () {
              ...
              if (!t.animating || !o.preventInteractionOnTransition) {
                ...
                if (
                  ...
                  (s.isTouchEvent || !("which" in r) || 3 !== r.which) &&
                    !(
                      (!s.isTouchEvent && "button" in r && 0 < r.button) ||
                  ...
                  if (
                    ...
                    ((a.currentX = (
                      "touchstart" === r.type ? r.targetTouches[0] : r
                    ).pageX),
                      (a.currentY = (
                        "touchstart" === r.type ? r.targetTouches[0] : r
                      ).pageY));
                    ...
                    (V(s, {
                      ...
                      "touchstart" !== r.type &&
                        ((u = !0),
                        l.is(s.formElements) && (u = !1),
                        i.activeElement &&
                          C(i.activeElement).is(s.formElements) &&
                          i.activeElement !== l[0] &&
                          i.activeElement.blur(),
                        (u =
                          u && t.allowTouchMove && o.touchStartPreventDefault),
                        (!o.touchStartForcePreventDefault && !u) ||
                ...
                if ((r.originalEvent && (r = r.originalEvent), n.isTouched)) {
                  if (!n.isTouchEvent || "touchmove" === r.type) {
                    ...
                    if (r.preventedByNestedSwiper)
                      return ((o.startX = e), void (o.startY = l));
                    if (!i.allowTouchMove)
                      return (
                        (i.allowClick = !1),
                        void (
                    ...
                    if (n.isTouchEvent && s.touchReleaseOnEdges && !s.loop)
                      if (i.isVertical()) {
                        if (
                          (l < o.startY && i.translate <= i.maxTranslate()) ||
                          (l > o.startY && i.translate >= i.minTranslate())
                        )
                          return ((n.isTouched = !1), void (n.isMoved = !1));
                      } else if (
                        (e < o.startX && i.translate <= i.maxTranslate()) ||
                        (e > o.startX && i.translate >= i.minTranslate())
                      )
                        return;
                    if (
                      n.isTouchEvent &&
                    ...
                    if (
                      ...
                      ((t = o.currentX - o.startX),
                        (e = o.currentY - o.startY));
                      if (
                        !(
                          i.params.threshold &&
                        ...
                        if (
                          ...
                          if (
                            (s.touchReleaseOnEdges && (a = 0),
                            0 < t && n.currentTranslate > i.minTranslate()
                              ? ((e = !1),
                                s.resistance &&
                                  (n.currentTranslate =
                                    i.minTranslate() -
                                    1 +
                                    Math.pow(
                                      -i.minTranslate() + n.startTranslate + t,
                                      a,
                                    )))
                              : t < 0 &&
                                ...
                                s.resistance &&
                                  (n.currentTranslate =
                                    ...
                                    1 -
                                    Math.pow(
                                      i.maxTranslate() - n.startTranslate - t,
                                      a,
                                    ))),
                ...
                if (
                  ...
                  if (n.freeMode)
                    if (u < -t.minTranslate()) t.slideTo(t.activeIndex);
                      ...
                      (!n.freeModeMomentum || e >= n.longSwipesMs) &&
                        (t.updateProgress(),
                        t.updateActiveIndex(),
                        t.updateSlidesClasses());
                    }
                    ...
                    for (
                      ...
                      void 0 !== r[E + T]
                        ? u >= r[E] &&
                          ...
                          (x = r[(w = E) + T] - r[E])
                        : u >= r[E] &&
                          ((w = E), (x = r[r.length - 1] - r[r.length - 2]));
                    }
                    ((v = (u - r[w]) / x),
                      (p =
                        w < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup));
                    e > n.longSwipesMs
                      ? n.longSwipes
                        ? ("next" === t.swipeDirection &&
                            (v >= n.longSwipesRatio
            ...
            (!r.touch && r.pointerEvents
              ...
              : (r.touch &&
                  ...
                  s.addEventListener(n.start, e.onTouchStart, l),
                  s.addEventListener(
                    n.move,
                    e.onTouchMove,
                    r.passiveListener ? { passive: !1, capture: d } : d,
                  ),
                  s.addEventListener(n.end, e.onTouchEnd, l),
                  n.cancel && s.addEventListener(n.cancel, e.onTouchEnd, l),
                  P || (t.addEventListener("touchstart", O), (P = !0))),
                ((i.simulateTouch && !a.ios && !a.android) ||
                  (i.simulateTouch && !r.touch && a.ios)) &&
          ...
          detachEvents: function () {
            ...
            (!l.touch && l.pointerEvents
              ? (o.removeEventListener(s.start, t.onTouchStart, !1),
                i.removeEventListener(s.move, t.onTouchMove, d),
                i.removeEventListener(s.end, t.onTouchEnd, !1))
              : (l.touch &&
                  ((e = !(
                  ...
                  o.removeEventListener(s.move, t.onTouchMove, d),
                  o.removeEventListener(s.end, t.onTouchEnd, e),
                  s.cancel && o.removeEventListener(s.cancel, t.onTouchEnd, e)),
                ((n.simulateTouch && !r.ios && !r.android) ||
                  (n.simulateTouch && !l.touch && r.ios)) &&
                  (o.removeEventListener("mousedown", t.onTouchStart, !1),
                  i.removeEventListener("mousemove", t.onTouchMove, d),
                  i.removeEventListener("mouseup", t.onTouchEnd, !1))),
        ...
        breakpoints: {
          setBreakpoint: function () {
            ...
            !u ||
              ...
              ((e = n.getBreakpoint(u, n.params.breakpointsBase, n.el)) &&
                ...
                (t = i || n.originalParams),
                (a = 1 < l.slidesPerColumn),
                ...
                (n.currentBreakpoint = e),
                n.emit("_beforeBreakpoint", t),
                l &&
                  o &&
                  (n.loopDestroy(),
                  n.loopCreate(),
                  n.updateSlides(),
                  n.slideTo(s - r + n.loopedSlides, 0, !1)),
                n.emit("breakpoint", t)));
          },
      ...
      B = {},
      H =
        (((j = N.prototype).setProgress = function (e, t) {
          var i = this;
        ...
        (j.slidesPerViewDynamic = function () {
          ...
          if (t.centeredSlides) {
            for (
              ...
              i[d] &&
                !r &&
                ((a += 1), (l += i[d].swiperSlideSize) > s && (r = !0));
            for (var u = o - 1; 0 <= u; --u)
              i[u] &&
                !r &&
                ((a += 1), (l += i[u].swiperSlideSize) > s && (r = !0));
          } else
            for (var c = o + 1; c < i.length; c += 1)
              n[c] - n[o] < s && (a += 1);
          return a;
        }),
        (j.update = function () {
    ...
    function N() {
      ...
      if (
        ...
        v && !i.el && (i.el = v),
        i.el && 1 < C(i.el).length)
      ) {
        var s = [];
        return (
          C(i.el).each(function (e) {
            e = V({}, i, { el: e });
            s.push(new N(e));
          }),
          s
      ...
      ((g.__swiper__ = !0),
        (g.support = $()),
        (g.device =
          (void 0 === (o = { userAgent: i.userAgent }) && (o = {}),
          x ||
            ((a = (void 0 === o ? {} : o).userAgent),
            (r = $()),
            (l = w()),
            (d = l.navigator.platform),
            (u = a || l.navigator.userAgent),
            (c = { ios: !1, android: !1 }),
            (p = l.screen.width),
            (h = l.screen.height),
            (m = u.match(/(Android);?[\s\/]+([\d.]+)?/)),
            (f = u.match(/(iPad).*OS\s([\d_]+)/)),
            (o = u.match(/(iPod)(.*OS\s([\d_]+))?/)),
            (a = !f && u.match(/(iPhone\sOS|iOS)\s([\d_]+)/)),
            (l = "Win32" === d),
            (d = "MacIntel" === d),
            !f &&
              d &&
              ...
              ((f = u.match(/(Version)\/([\d.]+)/)) || (f = [0, 1, "13_0_0"]),
              (d = !1)),
            m && !l && ((c.os = "android"), (c.android = !0)),
            (f || a || o) && ((c.os = "ios"), (c.ios = !0)),
            (x = c)),
          x)),
        (g.browser =
          (E ||
      ...
      return (
        g.useParams(y),
        (g.params = V({}, y, B, i)),
        (g.originalParams = V({}, g.params)),
        (g.passedParams = V({}, i)),
        g.params &&
          g.params.on &&
          Object.keys(g.params.on).forEach(function (e) {
        ...
        V(g, {
          ...
          touchEvents:
            ...
            (g.touchEventsDesktop = { start: y[0], move: y[1], end: y[2] }),
    ...
    var R = {
        update: function (e) {
          ...
          var a = t.activeIndex || 0,
            ...
            r = o
              ? ((v = Math.floor(n / 2) + s + l), Math.floor(n / 2) + s + r)
              : ((v = n + (s - 1) + l), s + r),
            f = Math.max((a || 0) - r, 0),
          ...
          if (
            ...
            return (
              t.slidesGrid !== h && v !== i && t.slides.css(d, v + "px"),
      ...
      G = {
        handle: function (e) {
          var t = this,
            ...
            o = e,
            a =
              (o = o.originalEvent ? o.originalEvent : o).keyCode || o.charCode,
          ...
          if (
            !t.allowSlidePrev &&
            ((t.isHorizontal() && u) || (t.isVertical() && p) || l)
          )
            return !1;
          if (
            !(
            ...
            (t.isHorizontal()
              ? ((l || d || u || c) &&
                  (o.preventDefault
                    ? o.preventDefault()
                    : (o.returnValue = !1)),
                (((d || c) && !s) || ((l || u) && s)) && t.slideNext(),
                (((l || u) && !s) || ((d || c) && s)) && t.slidePrev())
              : ((l || d || p || e) &&
                  (o.preventDefault
                    ? o.preventDefault()
                    : (o.returnValue = !1)),
      ...
      F = {
        ...
        event: function () {
          return -1 < w().navigator.userAgent.indexOf("firefox")
            ...
            : ((t = b()),
              (n = (i = "onwheel") in t) ||
                ((e = t.createElement("div")).setAttribute(i, "return;"),
                (n = "function" == typeof e.onwheel)),
              (n =
                !n &&
                t.implementation &&
        ...
        handle: function (e) {
          ...
          if (
            ((a = a >= i.minTranslate() ? i.minTranslate() : a) <=
              i.maxTranslate() && (a = i.maxTranslate()),
            (i.params.loop ||
            ...
            var r = { time: z(), delta: Math.abs(o), direction: Math.sign(o) },
            ...
            if (!a) {
              ...
              var l,
                d,
                u = i.getTranslate() + o * n.sensitivity,
                s = i.isBeginning,
                n = i.isEnd;
              if (
                ((u = u >= i.minTranslate() ? i.minTranslate() : u) <=
                  i.maxTranslate() && (u = i.maxTranslate()),
                i.setTransition(0),
                i.setTranslate(u),
                i.updateProgress(),
                i.updateActiveIndex(),
                i.updateSlidesClasses(),
                ((!s && i.isBeginning) || (!n && i.isEnd)) &&
                  i.updateSlidesClasses(),
        ...
        animateSlider: function (e) {
          ...
          return !(
            ...
            (this.params.mousewheel.thresholdTime &&
              z() - t.mousewheel.lastScrollTime <
                this.params.mousewheel.thresholdTime) ||
            (!(6 <= e.delta && z() - t.mousewheel.lastScrollTime < 60) &&
              (e.direction < 0
      ...
      X = {
        update: function () {
          ...
          if (
            ...
            if (
              ...
              if (
                (i.dynamicBullets &&
                  ...
                  (d =
                    ((l = r + (Math.min(p.length, i.dynamicMainBullets) - 1)) +
                      r) /
                    2)),
                p.removeClass(
                  i.bulletActiveClass +
                ...
                if ((h.addClass(i.bulletActiveClass), i.dynamicBullets)) {
                  for (var s = p.eq(r), h = p.eq(l), f = r; f <= l; f += 1)
            ...
            ("fraction" === i.type &&
              (o.find(M(i.currentClass)).text(i.formatFractionCurrent(n + 1)),
              o.find(M(i.totalClass)).text(i.formatFractionTotal(a))),
              "progressbar" === i.type &&
                ...
                o
                  .find(M(i.progressbarFillClass))
                  .transform(
                    "translate3d(0,0,0) scaleX(" + c + ") scaleY(" + u + ")",
                  )
                  .transition(e.params.speed)),
              "custom" === i.type && i.renderCustom
                ? (o.html(i.renderCustom(e, n + 1, a)),
        ...
        init: function () {
          ...
          !i.el ||
            (0 !== (e = C(i.el)).length &&
              ...
              i.clickable &&
                e.on("click", M(i.bulletClass), function (e) {
                  e.preventDefault();
        ...
        destroy: function () {
          ...
          i.el &&
            ...
            i.clickable && e.off("click", M(i.bulletClass)));
        },
      },
      U = {
        ...
        updateSize: function () {
          ...
          r.params.scrollbar.el &&
            ...
            (o = (s = r.size / r.virtualSize) * (n / r.size)),
            (a =
            ...
            V(e, { trackSize: n, divider: s, moveDivider: o, dragSize: a }),
            e.$el[
        ...
        enableDraggable: function () {
          ...
          r.params.scrollbar.el &&
            ...
            s &&
              (n.touch
                ? (s.addEventListener(t.start, r.scrollbar.onDragStart, o),
                  s.addEventListener(t.move, r.scrollbar.onDragMove, o),
                  s.addEventListener(t.end, r.scrollbar.onDragEnd, a))
                : (s.addEventListener(i.start, r.scrollbar.onDragStart, o),
                  e.addEventListener(i.move, r.scrollbar.onDragMove, o),
                  e.addEventListener(i.end, r.scrollbar.onDragEnd, a))));
        },
        disableDraggable: function () {
          ...
          r.params.scrollbar.el &&
            ...
            s &&
              (n.touch
                ? (s.removeEventListener(t.start, r.scrollbar.onDragStart, o),
                  s.removeEventListener(t.move, r.scrollbar.onDragMove, o),
                  s.removeEventListener(t.end, r.scrollbar.onDragEnd, a))
                : (s.removeEventListener(i.start, r.scrollbar.onDragStart, o),
                  e.removeEventListener(i.move, r.scrollbar.onDragMove, o),
                  e.removeEventListener(i.end, r.scrollbar.onDragEnd, a))));
        },
        init: function () {
          var e,
            t,
          ...
          s.params.scrollbar.el &&
            ((e = s.scrollbar),
            (n = s.$el),
            (i = C((t = s.params.scrollbar).el)),
            0 ===
              (n = (i =
                s.params.uniqueNavElements &&
                "string" == typeof t.el &&
                1 < i.length &&
                1 === n.find(t.el).length
                  ? n.find(t.el)
                  : i).find("." + s.params.scrollbar.dragClass)).length &&
              ((n = C(
                '<div class="' + s.params.scrollbar.dragClass + '"></div>',
              )),
              i.append(n)),
            V(e, { $el: i, el: i[0], $dragEl: n, dragEl: n[0] }),
      ...
      Q = {
        setTransform: function (e, t) {
          ...
          (a || r
            ...
            null != i &&
              ((i = i - (i - 1) * (1 - Math.abs(t))), (n[0].style.opacity = i)),
            null == e
              ? n.transform("translate3d(" + a + ", " + r + ", 0px)")
              : ((t = e - (e - 1) * (1 - Math.abs(t))),
                n.transform(
                  "translate3d(" + a + ", " + r + ", 0px) scale(" + t + ")",
                )));
        },
        setTranslate: function () {
          var n = this,
      ...
      K = {
        ...
        onGestureStart: function (e) {
          ...
          if (
            ...
            ((s.fakeGestureTouched = !0),
              (o.scaleStart = K.getDistanceBetweenTouches(e)));
          }
        ...
        onGestureEnd: function (e) {
          ...
          a.$imageEl &&
            0 !== a.$imageEl.length &&
            ((o.scale = Math.max(Math.min(o.scale, a.maxRatio), s.minRatio)),
            a.$imageEl
        ...
        onTouchMove: function (e) {
          ...
          if (
            ...
            s.isMoved ||
              ...
              (s.startX = v(n.$imageWrapEl[0], "x") || 0),
              (s.startY = v(n.$imageWrapEl[0], "y") || 0),
        ...
        onTouchEnd: function () {
          ...
          if (t.$imageEl && 0 !== t.$imageEl.length) {
            ...
            (0 !== n.x && (s = Math.abs((r - i.currentX) / n.x)),
              0 !== n.y && (o = Math.abs((a - i.currentY) / n.y)));
            o = Math.max(s, o);
        ...
        in: function (e) {
          ...
          (l.$slideEl ||
            ...
            l.$imageEl &&
              ...
              (a.scale = l.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio),
              (a.currentScale =
                l.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio),
              e
                ? ((r = l.$slideEl[0].offsetWidth),
                  (e = l.$slideEl[0].offsetHeight),
                  (i = l.$slideEl.offset().left + o.scrollX + r / 2 - t),
                  (n = l.$slideEl.offset().top + o.scrollY + e / 2 - d),
                  (o = l.$imageEl[0].offsetWidth),
                  (d = l.$imageEl[0].offsetHeight),
                  (o = o * a.scale),
                  (d = d * a.scale),
                  (o = -(r = Math.min(r / 2 - o / 2, 0))),
                  (d = -(e = Math.min(e / 2 - d / 2, 0))),
                  o < (i = (i = i * a.scale) < r ? r : i) && (i = o),
                  d < (n = (n = n * a.scale) < e ? e : n) && (n = d))
                : (n = i = 0),
              l.$imageWrapEl
                .transition(300)
        ...
        enable: function () {
          ...
          o.enabled ||
            ...
            (n.zoom.passiveListener = e),
            (n.zoom.slideSelector = i),
            s.gestures
              ? (n.$wrapperEl.on(n.touchEvents.start, n.zoom.enableGestures, e),
                n.$wrapperEl.on(n.touchEvents.end, n.zoom.disableGestures, e))
              : "touchstart" === n.touchEvents.start &&
                (n.$wrapperEl.on(n.touchEvents.start, i, o.onGestureStart, e),
                n.$wrapperEl.on(n.touchEvents.move, i, o.onGestureChange, t),
                n.$wrapperEl.on(n.touchEvents.end, i, o.onGestureEnd, e),
                n.touchEvents.cancel &&
                  n.$wrapperEl.on(n.touchEvents.cancel, i, o.onGestureEnd, e)),
            n.$wrapperEl.on(
              n.touchEvents.move,
        ...
        disable: function () {
          ...
          o.enabled &&
            ...
            (n = "." + s.params.slideClass),
            e.gestures
              ? (s.$wrapperEl.off(
                  s.touchEvents.start,
                  s.zoom.enableGestures,
                  t,
                ),
                s.$wrapperEl.off(s.touchEvents.end, s.zoom.disableGestures, t))
              : "touchstart" === s.touchEvents.start &&
                (s.$wrapperEl.off(s.touchEvents.start, n, o.onGestureStart, t),
                s.$wrapperEl.off(s.touchEvents.move, n, o.onGestureChange, i),
                s.$wrapperEl.off(s.touchEvents.end, n, o.onGestureEnd, t),
                s.touchEvents.cancel &&
                  s.$wrapperEl.off(s.touchEvents.cancel, n, o.onGestureEnd, t)),
            s.$wrapperEl.off(
              s.touchEvents.move,
                ...
                (u.loadImage(i[0], s || n, o, a, !1, function () {
                  ...
                  null == u ||
                    ...
                    (n
                      ...
                      : (o &&
                          (i.attr("srcset", o), i.removeAttr("data-srcset")),
                        a && (i.attr("sizes", a), i.removeAttr("data-sizes")),
                        r.length &&
                          r.children("source").each(function (e) {
                            e = C(e);
                            e.attr("data-srcset") &&
            ...
            if (1 < r || (a.loadPrevNextAmount && 1 < a.loadPrevNextAmount)) {
              for (
                var c = a.loadPrevNextAmount,
                  a = r,
                  p = Math.min(e + a + Math.max(c, a), s.length),
                  c = Math.max(e - Math.max(a, c), 0),
                  h = e + r;
                h < p;
                h += 1
              )
      ...
      ee = {
        ...
        onEnterOrSpaceKey: function (e) {
          ...
          (13 !== e.keyCode && 32 !== e.keyCode) ||
            ...
            t.pagination &&
              e.is(M(t.params.pagination.bulletClass)) &&
              e[0].click());
        },
        notify: function (e) {
        ...
        init: function () {
          ...
          (n.containerRoleDescriptionMessage &&
            i.a11y.addElRoleDescription(e, n.containerRoleDescriptionMessage),
            n.containerMessage && i.a11y.addElLabel(e, n.containerMessage));
          var t,
            s,
            o = i.$wrapperEl,
          ...
          (i.a11y.addElId(o, a),
            i.a11y.addElLive(o, e),
            n.itemRoleDescriptionMessage &&
              i.a11y.addElRoleDescription(
                C(i.slides),
                n.itemRoleDescriptionMessage,
              ),
            i.a11y.addElRole(C(i.slides), n.slideRole),
            i.slides.each(function (e) {
              var t = C(e),
                e = n.slideLabelMessage
                  .replace(/\{\{index\}\}/, t.index() + 1)
                  .replace(/\{\{slidesLength\}\}/, i.slides.length);
              i.a11y.addElLabel(t, e);
            }),
            i.navigation && i.navigation.$nextEl && (t = i.navigation.$nextEl),
            i.navigation && i.navigation.$prevEl && (s = i.navigation.$prevEl),
            t &&
              t.length &&
              ...
              i.a11y.addElLabel(t, n.nextSlideMessage),
              i.a11y.addElControls(t, a)),
            s &&
              s.length &&
              (i.a11y.makeElFocusable(s),
              "BUTTON" !== s[0].tagName &&
                (i.a11y.addElRole(s, "button"),
                s.on("keydown", i.a11y.onEnterOrSpaceKey)),
              i.a11y.addElLabel(s, n.prevSlideMessage),
              i.a11y.addElControls(s, a)),
            i.pagination &&
              ...
              i.pagination.$el.on(
                "keydown",
                M(i.params.pagination.bulletClass),
      ...
      te = {
        init: function () {
          ...
          if (e.params.history) {
            ...
            var i = e.history;
            ((i.initialized = !0),
              (i.paths = te.getPathValues(e.params.url)),
        ...
        setHistoryPopState: function () {
          var e = this;
          ((e.history.paths = te.getPathValues(e.params.url)),
        ...
        setHistory: function (e, t) {
          ...
          s.history.initialized &&
            ...
            ((i = s.params.url ? new URL(s.params.url) : o.location),
            (n = s.slides.eq(t)),
            (t = te.slugify(n.attr("data-history"))),
            0 < s.params.history.root.length
              ? (t =
                  (n =
                    "/" === (n = s.params.history.root)[n.length - 1]
            ...
            ((e = o.history.state) && e.value === t) ||
              (s.params.history.replaceState
                ? o.history.replaceState({ value: t }, null, t)
                : o.history.pushState({ value: t }, null, t)));
        },
        slugify: function (e) {
          return e
            .toString()
        ...
        init: function () {
          ...
          if (
            ...
            e.params.hashNavigation.watchState &&
              C(i).on("hashchange", e.hashNavigation.onHashCange);
          }
        },
        destroy: function () {
          var e = w();
        ...
        setTranslate: function () {
          ...
          for (var m, f = 0; f < s.length; f += 1) {
            var g = s.eq(f),
              ...
              y =
                90 *
                (v = p ? parseInt(g.attr("data-swiper-slide-index"), 10) : v),
              b = Math.floor(y / 360);
            ...
            (v % 4 == 0
              ...
              r && (x = -x),
              c || ((E = x), (x = 0)),
              w <= 1 && -1 < w && (h = r ? 90 * -v - 90 * w : 90 * v + 90 * w),
              g.transform(
                "rotateX(" +
                  (c ? 0 : -y) +
                  "deg) rotateY(" +
        ...
        setTranslate: function () {
          for (
            ...
            var s,
              ...
              l =
                -180 *
                (r = e.params.flipEffect.limitRotation
            ...
            (e.isHorizontal()
              ...
              e.params.flipEffect.slideShadows &&
                ...
                o.length && (o[0].style.opacity = Math.max(r, 0))),
              a.transform(
                "translate3d(" +
                  u +
                  "px, " +
      ...
      le = {
          ...
          return (
            t.swiper instanceof i
              ? ((e.thumbs.swiper = t.swiper),
                V(e.thumbs.swiper.originalParams, {
        ...
        onThumbClick: function () {
          ...
          s &&
            ((t = s.clickedIndex),
            ((e = s.clickedSlide) &&
              C(e).hasClass(n.params.thumbs.slideThumbActiveClass)) ||
              null == t ||
              ((i = s.params.loop
                ? parseInt(
        ...
        update: function (e) {
          ...
          if (i) {
            ...
            if (
              ...
              for (var p = 0; p < d; p += 1)
                i.slides.eq(t.realIndex + p).addClass(u);
          }
        },
      };
    return (
      H.use([
        ...
        },
        {
          ...
          create: function () {
            T(this, { pagination: t({ dynamicBulletIndex: 0 }, X) });
          },
          on: {
            init: function (e) {
              (e.pagination.init(),
        ...
        },
        {
          ...
          create: function () {
            T(this, { lazy: t({ initialImageLoaded: !1 }, Z) });
          },
          on: {
            beforeInit: function (e) {
        ...
        },
        {
          ...
          create: function () {
            T(this, {
              controller: t({ control: this.params.controller.control }, J),
            });
          },
          on: {
            update: function (e) {
        ...
        },
        {
          ...
          create: function () {
            T(this, { hashNavigation: t({ initialized: !1 }, ie) });
          },
          on: {
            init: function (e) {
        ...
        },
        {
          ...
          create: function () {
            T(this, { autoplay: t({}, ne, { running: !1, paused: !1 }) });
          },
          on: {
            init: function (e) {
