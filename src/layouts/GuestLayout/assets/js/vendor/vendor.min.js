(!(function (e, t) {
  ...
  function j(e, t, n, i, r) {
    ...
    ((y.delegationSelector = d ? n : null),
      (y.callable = f),
      (y.oneOff = r),
      (y.uidEvent = v),
      (g[v] = y),
      e.addEventListener(h, y, d));
  }
  ...
  let O = {
    ...
    off(e, t, n, i) {
      ...
      let [r, o, s] = N(t, n, i),
        ...
        u = t.startsWith(".");
      if (void 0 === o) {
        if (u) for (let d of Object.keys(l)) P(e, l, d, t.slice(1));
  ...
  let R = {
    ...
    getDataAttributes(e) {
      ...
      for (let i of n) {
        let r = i.replace(/^bs/, "");
        t[(r = r.charAt(0).toLowerCase() + r.slice(1, r.length))] = F(
          e.dataset[i],
        );
      }
      return t;
  ...
  let Q = (e, t = "hide") => {
    ...
    O.on(document, n, `[data-bs-dismiss="${i}"]`, function (n) {
      if ((["A", "AREA"].includes(this.tagName) && n.preventDefault(), u(this)))
        return;
  ...
  class J extends z {
    ...
    _initEvents() {
      this._supportPointerEvents
        ? (O.on(this._element, "pointerdown.bs.swipe", (e) => this._start(e)),
          O.on(this._element, "pointerup.bs.swipe", (e) => this._end(e)),
          this._element.classList.add("pointer-event"))
        : (O.on(this._element, "touchstart.bs.swipe", (e) => this._start(e)),
          O.on(this._element, "touchmove.bs.swipe", (e) => this._move(e)),
          O.on(this._element, "touchend.bs.swipe", (e) => this._end(e)));
    }
  ...
  class ec extends B {
    constructor(e, t) {
      (super(e, t),
        ...
        this._config.ride === er && this.cycle());
    }
    static get Default() {
      return ea;
    }
    ...
    _maybeEnableCycle() {
      this._config.ride &&
        (this._isSliding
          ? O.one(this._element, ei, () => this.cycle())
          : this.cycle());
    }
    to(e) {
      ...
      if (this._isSliding)
        return void O.one(this._element, ei, () => this.to(e));
    ...
    _addEventListeners() {
      (this._config.keyboard &&
        O.on(this._element, "keydown.bs.carousel", (e) => this._keydown(e)),
        "hover" === this._config.pause &&
          (O.on(this._element, "mouseenter.bs.carousel", () => this.pause()),
    ...
    _addTouchEventListeners() {
      for (let e of Y.find(".carousel-item img", this._element))
      ...
      if (
        (this._config.parent &&
          (e = this._getFirstLevelChildren(
            ...
            .map((e) => em.getOrCreateInstance(e, { toggle: !1 }))),
  ...
  class ej extends B {
    constructor(e, t) {
      (super(e, t),
        ...
        (this._menu =
          Y.next(this._element, eC)[0] ||
          Y.prev(this._element, eC)[0] ||
          Y.findOne(eC, this._parent)),
    ...
    _getConfig(e) {
      if (
        ...
        throw TypeError(
          `${ev.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`,
        );
      return e;
    }
    _createPopper() {
    ...
    static dataApiKeydownHandler(e) {
      ...
      if ((!i && !n) || (t && !n)) return;
      e.preventDefault();
      let r = this.matches(ew)
          ? this
          : Y.prev(this, ew)[0] ||
            Y.next(this, ew)[0] ||
            Y.findOne(ew, e.delegateTarget.parentNode),
  ...
  (O.on(document, e8, ew, ej.dataApiKeydownHandler),
    O.on(document, e8, eC, ej.dataApiKeydownHandler),
    O.on(document, eb, ej.clearMenus),
    O.on(document, "keyup.bs.dropdown.data-api", ej.clearMenus),
    O.on(document, eb, ew, function (e) {
  ...
  class eM {
    ...
    hide() {
      ...
      (this._disableOverFlow(),
        ...
        this._setElementAttributes(eL, eI, (t) => t + e),
        this._setElementAttributes(eP, eO, (t) => t - e));
    }
    reset() {
      (this._resetElementAttributes(this._element, "overflow"),
        this._resetElementAttributes(this._element, eI),
        this._resetElementAttributes(eL, eI),
        this._resetElementAttributes(eP, eO));
    }
    isOverflowing() {
    ...
    _resetElementAttributes(e, t) {
      this._applyManipulationCallback(e, (e) => {
        ...
        null !== n
          ? (R.removeDataAttribute(e, t), e.style.setProperty(t, n))
          : e.style.removeProperty(t);
      });
    }
    _applyManipulationCallback(e, t) {
      if (a(e)) t(e);
      else for (let n of Y.find(e, this._element)) t(n);
    }
  }
  let eq = "show",
  ...
  class eW extends z {
    ...
    hide(e) {
      this._config.isVisible
        ? (this._getElement().classList.remove(eq),
          this._emulateAnimation(() => {
            (this.dispose(), y(e));
          }))
        : y(e);
  ...
  let e0 = ".bs.focustrap",
    ...
    eB = { autofocus: "boolean", trapElement: "element" };
  class e1 extends z {
    constructor(e) {
      (super(),
        (this._config = this._getConfig(e)),
    ...
    activate() {
      this._isActive ||
        ...
        O.off(document, e0),
        O.on(document, "focusin.bs.focustrap", (e) => this._handleFocusin(e)),
    ...
    _handleKeydown(e) {
      "Tab" === e.key &&
        (this._lastTabNavDirection = e.shiftKey ? eR : "forward");
    }
  }
  ...
  class e4 extends B {
    ...
    show(e) {
      this._isShown ||
        this._isTransitioning ||
        O.trigger(this._element, e3, { relatedTarget: e }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
    ...
    _initializeFocusTrap() {
      return new e1({ trapElement: this._element });
    }
    _showElement(e) {
        ...
        this._queueCallback(
          () => {
            (this._config.focus && this._focustrap.activate(),
              (this._isTransitioning = !1),
              O.trigger(this._element, "shown.bs.modal", { relatedTarget: e }));
          },
          this._dialog,
          this._isAnimated(),
        ));
    ...
    _hideModal() {
      ((this._element.style.display = "none"),
        ...
        (this._isTransitioning = !1),
        this._backdrop.hide(() => {
          (document.body.classList.remove(eV),
            this._resetAdjustments(),
            this._scrollBar.reset(),
            O.trigger(this._element, eQ));
        }));
    }
    _isAnimated() {
    ...
    _triggerBackdropTransition() {
      if (O.trigger(this._element, "hidePrevented.bs.modal").defaultPrevented)
        return;
      let e =
          this._element.scrollHeight > document.documentElement.clientHeight,
        t = this._element.style.overflowY;
      "hidden" === t ||
        this._element.classList.contains(eX) ||
        (e || (this._element.style.overflowY = "hidden"),
        this._element.classList.add(eX),
        this._queueCallback(() => {
          (this._element.classList.remove(eX),
            this._queueCallback(() => {
  ...
  class tt extends B {
    ...
    show(e) {
      this._isShown ||
        O.trigger(this._element, "show.bs.offcanvas", { relatedTarget: e })
          .defaultPrevented ||
        ((this._isShown = !0),
        this._backdrop.show(),
        this._config.scroll || new eM().hide(),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
    ...
    hide() {
      this._isShown &&
        (O.trigger(this._element, "hide.bs.offcanvas").defaultPrevented ||
          (this._focustrap.deactivate(),
          this._element.blur(),
          (this._isShown = !1),
          ...
          this._queueCallback(
            () => {
              (this._element.classList.remove(e7, eG),
                this._element.removeAttribute("aria-modal"),
                this._element.removeAttribute("role"),
                this._config.scroll || new eM().reset(),
                O.trigger(this._element, e5));
            },
            this._element,
            !0,
          )));
    ...
    _addEventListeners() {
      O.on(this._element, "keydown.dismiss.bs.offcanvas", (e) => {
        "Escape" === e.key &&
          (this._config.keyboard ? this.hide() : O.trigger(this._element, e6));
      });
    }
    static jQueryInterface(e) {
      return this.each(function () {
  ...
  (O.on(
    ...
    O.on(window, "resize.bs.offcanvas", () => {
      for (let e of Y.find("[aria-modal][class*=show][class*=offcanvas-]"))
        "fixed" !== getComputedStyle(e).position &&
          tt.getOrCreateInstance(e).hide();
    }),
    Q(tt),
    v(tt));
  let tn = new Set([
    ...
    to = (e, t) => {
      ...
      return t.includes(n)
        ? !tn.has(n) || Boolean(ti.test(e.nodeValue) || tr.test(e.nodeValue))
  ...
  class tu extends z {
    ...
    _checkContent(e) {
      for (let [t, n] of Object.entries(e))
        super._typeCheckConfig({ selector: t, entry: n }, tc);
    }
    _setContent(e, t, n) {
      let i = Y.findOne(n, e);
      i &&
  ...
  class t$ extends B {
    ...
    dispose() {
      (clearTimeout(this._timeout),
        O.off(this._element.closest(tp), tg, this._hideModalHandler),
    ...
    hide() {
      if (
        ...
        if (
          (this._getTipElement().classList.remove(th),
          "ontouchstart" in document.documentElement)
        )
    ...
    _createTipElement(e) {
      ...
      return (
        t.setAttribute("id", n),
        this._isAnimated() && t.classList.add(tf),
        t
      );
    }
    setContent(e) {
    ...
    _isAnimated() {
      return (
        this._config.animation || (this.tip && this.tip.classList.contains(tf))
      );
    }
    _isShown() {
      ...
      for (let t of e)
        if ("click" === t)
          ...
          (O.on(this._element, n, this._config.selector, (e) => {
            ...
            ((t._activeTrigger["focusin" === e.type ? tv : tm] = !0),
              t._enter());
          }),
            O.on(this._element, i, this._config.selector, (e) => {
              let t = this._initializeOnDelegatedTarget(e);
              ((t._activeTrigger["focusout" === e.type ? tv : tm] =
  ...
  class tS extends B {
    ...
    _maybeEnableSmoothScroll() {
      this._config.smoothScroll &&
        (O.off(this._config.target, t_),
        O.on(this._config.target, t_, tA, (e) => {
    ...
    _activateParents(e) {
      if (e.classList.contains("dropdown-item"))
        Y.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(tT);
      else
  ...
  class tM extends B {
    constructor(e) {
      (super(e),
        ...
        this._parent &&
          ...
          O.on(this._element, "keydown.bs.tab", (e) => this._keydown(e))));
    }
    static get NAME() {
      return "tab";
    }
    show() {
      ...
      let t = this._getActiveElem(),
        n = t ? O.trigger(t, "hide.bs.tab", { relatedTarget: e }) : null;
      O.trigger(e, "show.bs.tab", { relatedTarget: t }).defaultPrevented ||
          ...
          () => {
            "tab" === e.getAttribute("role")
              ? (e.removeAttribute("tabindex"),
                ...
                O.trigger(e, "shown.bs.tab", { relatedTarget: t }))
              : e.classList.add(tP);
          },
          e,
          e.classList.contains(tL),
        ));
    }
    _deactivate(e, t) {
      e &&
        (e.classList.remove(tj),
        e.blur(),
          ...
          () => {
            "tab" === e.getAttribute("role")
              ? (e.setAttribute("aria-selected", !1),
                ...
                O.trigger(e, "hidden.bs.tab", { relatedTarget: t }))
    ...
    _keydown(e) {
      ...
      n && (n.focus({ preventScroll: !0 }), tM.getOrCreateInstance(n).show());
    }
    _getChildren() {
  ...
  (O.on(document, "click.bs.tab", tI, function (e) {
    (["A", "AREA"].includes(this.tagName) && e.preventDefault(),
      u(this) || tM.getOrCreateInstance(this).show());
  }),
  ...
  let tq = "hide",
    tH = "show",
    t9 = "showing",
    tF = { animation: "boolean", autohide: "boolean", delay: "number" },
    tW = { animation: !0, autohide: !0, delay: 5e3 };
  class t0 extends B {
    constructor(e, t) {
      (super(e, t),
        (this._timeout = null),
    ...
    show() {
      O.trigger(this._element, "show.bs.toast").defaultPrevented ||
        ...
        h(this._element),
        this._element.classList.add(tH, t9),
        this._queueCallback(
          () => {
            (this._element.classList.remove(t9),
    ...
    hide() {
      this.isShown() &&
        (O.trigger(this._element, "hide.bs.toast").defaultPrevented ||
          (this._element.classList.add(t9),
          this._queueCallback(
            () => {
              (this._element.classList.add(tq),
                this._element.classList.remove(t9, tH),
    ...
    dispose() {
      (this._clearTimeout(),
        this.isShown() && this._element.classList.remove(tH),
        super.dispose());
    }
    isShown() {
  ...
  (function (e, t) {
        ...
        return (
          ...
          eu(function (o, s, a, l) {
            var c,
              ...
              v = n ? (r || (o ? e : p || i) ? [] : s) : m;
            if ((n && n(m, v, a, l), i))
              for (c = ex(v, h), i(c, [], a, l), u = c.length; u--; )
                (d = c[u]) && (v[h[u]] = !(m[h[u]] = d));
            if (o) {
              if (r || e) {
                if (r) {
              ...
              ((v = ex(v === s ? v.splice(p, v.length) : v)),
          ...
          function (e, t, n, r) {
            ...
            if (((n = n || []), 1 === h.length)) {
              if (
                ...
                if (
                  !(t = (i.find.ID(c.matches[0].replace(et, en), t) || [])[0])
                )
                  return n;
                (f && (t = t.parentNode),
    ...
    (((w.fn.init = function (e, t, n) {
      ...
      if (((n = n || D), "string" == typeof e)) {
        ...
        return (
          (r = m.getElementById(i[2])) && ((this[0] = r), (this.length = 1)),
          this
        );
      }
      return e.nodeType
          ...
          var n = [
            ...
            r = {
              ...
              then: function (t, i, r) {
                ...
                return w
                  .Deferred(function (e) {
                    (n[0][3].add(s(0, e, p(r) ? r : O, e.notifyWith)),
                      n[1][3].add(s(0, e, p(t) ? t : O)),
    ...
    var es = function (e, t) {
      return (
        ...
        ("" === e.style.display && er(e) && "none" === w.css(e, "display"))
      );
    };
    function ea(e, t, n, i) {
      var r,
    ...
    function eb(e, t, n, i, r) {
      ...
      for (d.textContent = "", h = 0; (o = f[h++]); )
        if (i && -1 < w.inArray(o, i)) r && r.push(o);
          ...
          ((c = er(o)), (s = em(d.appendChild(o), "script")), c && ev(s), n)
        )
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            var t = this || e;
            return (
              ef.test(t.type) && t.click && E(t, "input") && eA(t, "click", ex),
              !1
            );
          },
          trigger: function (e) {
            var t = this || e;
            return (
              ef.test(t.type) && t.click && E(t, "input") && eA(t, "click"),
              !0
            );
          },
          _default: function (e) {
      ...
      w.each(
        {
          ...
          which: function (e) {
            var t = e.button;
            return null == e.which && e8.test(e.type)
              ? null != e.charCode
                ? e.charCode
                : e.keyCode
    ...
    function eP(e, t, n, i) {
      ...
      var r,
        ...
        m = t[0],
        v = p(m);
      if (v || (1 < f && "string" == typeof m && !h.checkClone && ek.test(m)))
      ...
      if (
        ...
        for (l = (a = w.map(em(r, "script"), eN)).length; d < f; d++)
          ((c = r),
            d !== g &&
              ((c = w.clone(c, !0, !0)), l && w.merge(a, em(c, "script"))),
            n.call(e[d], c, d));
        if (l)
          for (
            u = a[a.length - 1].ownerDocument, w.map(a, ej), d = 0;
            d < l;
            d++
          )
            ((c = a[d]),
              ep.test(c.type || "") &&
                ...
                (c.src && "module" !== (c.type || "").toLowerCase()
                  ...
                  : y(c.textContent.replace(eS, ""), c, u)));
      }
      return e;
    }
    function eI(e, t, n) {
      for (var i, r = t ? w.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
        (n || 1 !== i.nodeType || w.cleanData(em(i)),
          i.parentNode &&
            (n && er(i) && ev(em(i, "script")), i.parentNode.removeChild(i)));
      return e;
    }
    (w.extend({
      ...
      clone: function (e, t, n) {
        ...
        return (
          0 < (s = em(u, "script")).length && ev(s, !d && em(e, "script")),
          u
        );
      },
      ...
      w.fn.extend({
        ...
        empty: function () {
          for (var e, t = 0; null != (e = this[t]); t++)
            1 === e.nodeType && (w.cleanData(em(e, !1)), (e.textContent = ""));
          return this;
        },
        clone: function (e, t) {
          return (
          ...
          return R(
            ...
            function (e) {
              ...
              if (
                "string" == typeof e &&
                !eE.test(e) &&
                !eg[(eh.exec(e) || ["", ""])[1].toLowerCase()]
              ) {
                e = w.htmlPrefilter(e);
                try {
                  for (; n < i; n++)
                    1 === (t = this[n] || {}).nodeType &&
                      (w.cleanData(em(t, !1)), (t.innerHTML = e));
                  t = 0;
                } catch (r) {}
              }
        ...
        replaceWith: function () {
          ...
          return eP(
            ...
            function (t) {
              ...
              0 > w.inArray(this, e) &&
                (w.cleanData(em(this)), n && n.replaceChild(t, this));
            },
            e,
          );
        },
          ...
          reliableTrDimensions: function () {
            ...
            return (
              null == a &&
                ...
                (a = 3 < parseInt((r = e.getComputedStyle(n)).height)),
                ei.removeChild(t)),
              a
            );
          },
    ...
    function eU(e, t, n, i, r, o) {
      ...
      for (; s < 4; s += 2)
        ("margin" === n && (l += w.css(e, n + en[s], !0, r)),
          i
            ? ("content" === n && (l -= w.css(e, "padding" + en[s], !0, r)),
              "margin" !== n &&
                (l -= w.css(e, "border" + en[s] + "Width", !0, r)))
            : ((l += w.css(e, "padding" + en[s], !0, r)),
              "padding" !== n
                ? (l += w.css(e, "border" + en[s] + "Width", !0, r))
                : (a += w.css(e, "border" + en[s] + "Width", !0, r))));
      return (
        !i &&
          0 <= o &&
          (l +=
    ...
    function eX(e, t, n) {
      ...
      return (
        ((!h.boxSizingReliable() && r) ||
          ...
          (o = a in e) && (s = e[a])),
        (s = parseFloat(s) || 0) +
          eU(e, t, n || (r ? "border" : "content"), o, i, s) +
          "px"
      );
    }
    ...
    (w.extend({
      ...
      w.each(["height", "width"], function (e, t) {
        w.cssHooks[t] = {
          get: function (e, n, i) {
            if (n)
              return !eB.test(w.css(e, "display")) ||
        ...
        _default: {
          ...
          set: function (e) {
            w.fx.step[e.prop]
              ? w.fx.step[e.prop](e)
              : 1 === e.elem.nodeType &&
                  (w.cssHooks[e.prop] || null != e.elem.style[ez(e.prop)])
      ...
      for (
        (function (e, t) {
          ...
          for (n in e)
            if (
              ((r = t[(i = V(n))]),
              Array.isArray((o = e[n])) && ((r = o[1]), (o = e[n] = o[0])),
    ...
    ((w.Animation = w.extend(te, {
          ...
          if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(h))
            ...
            h))
              (l ||
                ...
                g && ec([e], !0),
                f.done(function () {
                  for (i in (g || ec([e]), Y.remove(e, "fxshow"), h))
                    w.style(e, i, h[i]);
                })),
                (l = eZ(g ? m[i] : 0, i, f)),
                i in m ||
        ...
        stop: function (e, t, n) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (r in s) s[r] && s[r].stop && eJ.test(r) && i(s[r]);
              for (r = o.length; r--; )
                o[r].elem !== this ||
                  (null != e && o[r].queue !== e) ||
      ...
      (e7 = m.createElement("input")),
      (eK = m.createElement("select").appendChild(m.createElement("option"))),
      (e7.type = "checkbox"),
      (h.checkOn = "" !== e7.value),
      (h.optSelected = eK.selected),
      ((e7 = m.createElement("input")).value = "t"),
      (e7.type = "radio"),
      (h.radioValue = "t" === e7.value));
    var tt,
      tn = w.expr.attrHandle;
    (w.fn.extend({
      attr: function (e, t) {
        ...
        propHooks: {
          tabIndex: {
            get: function (e) {
              ...
              return t
                ? parseInt(t, 10)
                : ti.test(e.nodeName) || (tr.test(e.nodeName) && e.href)
                  ? 0
                  : -1;
            },
          },
          ...
          return "boolean" == typeof t && i
            ...
            : p(e)
              ...
              : this.each(function () {
                  var t, r, o, s;
                  if (i)
                    for (r = 0, o = w(this), s = ta(e); (t = s[r++]); )
                      o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                  else
                    (void 0 !== e && "boolean" !== n) ||
                      ((t = ts(this)) && Y.set(this, "__className__", t),
                      this.setAttribute &&
                        this.setAttribute(
                          "class",
                          t || !1 === e
    ...
    (w.extend(w.event, {
      trigger: function (t, n, i, r) {
        ...
        if (
          ...
          if (!r && !f.noBubble && !g(i)) {
            for (
              l = f.delegateType || y, tc.test(l + y) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              (v.push(s), (a = s));
        ...
        ajax: function (t, n) {
          ...
          var i,
            ...
            _ = {
              ...
              setRequestHeader: function (e, t) {
                return (
                  null == c &&
                    ($[(e = x[e.toLowerCase()] = x[e.toLowerCase()] || e)] = t),
                  this
                );
              },
          ...
          if (
            ...
            try {
              ((l.href = h.url),
                (l.href = l.href),
                (h.crossDomain =
                  tE.protocol + "//" + tE.host != l.protocol + "//" + l.host));
            } catch (T) {
              h.crossDomain = !0;
            }
          }
          ...
          h.hasContent
            ? h.data &&
              ...
              (h.data = h.data.replace(tb, "+"))
            : ((f = h.url.slice(r.length)),
              h.data &&
                (h.processData || "string" == typeof h.data) &&
                ((r += (th.test(r) ? "&" : "?") + h.data), delete h.data),
              !1 === h.cache &&
                ((r = r.replace(t$, "$1")),
                (f = (th.test(r) ? "&" : "?") + "_=" + tf.guid++ + f)),
              (h.url = r + f)),
          h.ifModified &&
            (w.lastModified[r] &&
          ...
          _.setRequestHeader(
            ...
            h.dataTypes[0] && h.accepts[h.dataTypes[0]]
              ? h.accepts[h.dataTypes[0]] +
                  ("*" !== h.dataTypes[0] ? ", " + tA + "; q=0.01" : "")
              : h.accepts["*"],
          ),
          h.headers))
            _.setRequestHeader(d, h.headers[d]);
          if (h.beforeSend && (!1 === h.beforeSend.call(p, _, h) || c))
            return _.abort();
          if (
            ((C = "abort"),
            y.add(h.complete),
            ...
            if (((_.readyState = 1), u && g.trigger("ajaxSend", [_, h]), c))
              return _;
            h.async &&
              0 < h.timeout &&
              ...
              d
                ? (h.ifModified &&
                    ((x = _.getResponseHeader("Last-Modified")) &&
                      (w.lastModified[r] = x),
                    (x = _.getResponseHeader("etag")) && (w.etag[r] = x)),
                  204 === t || "HEAD" === h.type
                    ? (C = "nocontent")
                    : 304 === t
                      ? (C = "notmodified")
                      : ((C = $.state), (f = $.data), (d = !(m = $.error))))
                : ((m = C), (!t && C) || ((C = "error"), t < 0 && (t = 0))),
              (_.status = t),
              (_.statusText = (n || C) + ""),
              d ? v.resolveWith(p, [f, C, _]) : v.rejectWith(p, [_, C, m]),
              _.statusCode(b),
              (b = void 0),
              u &&
                g.trigger(d ? "ajaxSuccess" : "ajaxError", [_, h, d ? f : m]),
              y.fireWith(p, [_, C]),
              u &&
    ...
    ((h.cors = !!tj && "withCredentials" in tj),
      (h.ajax = tj = !!tj),
      w.ajaxTransport(function (t) {
        var n, i;
        if (h.cors || (tj && !t.crossDomain))
          return {
            send: function (r, o) {
              var s,
                a = t.xhr();
    ...
    (w.ajaxSetup({
          ...
          return (
            ...
            i.always(function () {
              (void 0 === o ? w(e).removeProp(r) : (e[r] = o),
                t[r] && ((t.jsonpCallback = n.jsonpCallback), tP.push(r)),
                s && p(o) && o(s[0]),
                (s = o = void 0));
            }),
            "script"
      ...
      (h.createHTMLDocument =
        (((tL = m.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
      ...
      (w.fn.load = function (e, t, n) {
        var i,
          ...
          a = e.indexOf(" ");
        return (
          -1 < a && ((i = to(e.slice(a))), (e = e.slice(0, a))),
          p(t)
            ? ((n = t), (t = void 0))
      ...
      w.each(["top", "left"], function (e, t) {
        w.cssHooks[t] = eF(h.pixelPosition, function (e, n) {
          if (n)
            return ((n = e9(e, t)), eO.test(n) ? w(e).position()[t] + "px" : n);
        });
      }),
  ...
  /*! jQuery Migrate v3.3.0 | (c) OpenJS Foundation and other contributors | jquery.org/license */ void 0 ===
  ...
  (function (e) {
    ...
    e.fn.removeAttr = function (t) {
      var n = this;
      return (
        e.each(t.match(v), function (t, i) {
          e.expr.match.bool.test(i) &&
            (r("jQuery.fn.removeAttr no longer sets boolean properties: " + i),
            n.prop(i, !1));
        }),
    ...
    (e.swap &&
      ...
      (e.swap = function (e, t, n, i) {
        var o,
          s,
          a = {};
        for (s in ($ || r("jQuery.swap() is undocumented and deprecated"), t))
      ...
      (e.fn.css = function (t, n) {
        ...
        return (
          ...
          "number" != typeof n ||
            ...
            r("Use of number-typed values is deprecated in jQuery.fn.css"),
    ...
    if (
      ((e.data = function (t, n, i) {
        ...
        if (n && "object" == typeof n && 2 === arguments.length) {
          for (a in ((o = e.hasData(t) && C.call(this, t)), (s = {}), n))
            a !== y(a)
              ? (r("jQuery.data() always sets/gets camelCased names: " + a),
                (o[a] = n[a]))
              : (s[a] = n[a]);
    ...
    ((e.event.props = []),
      ...
      (e.event.fix = function (t) {
        ...
        if (s.length)
          for (
            r("jQuery.event.props are deprecated and removed: " + s.join());
            s.length;
    ...
    if (
      ((e.fn.offset = function () {
        ...
        if (i && i.nodeType)
          return (
            (n = (i.ownerDocument || t.document).documentElement),
            e.contains(n, i)
  ...
  (window.Modernizr = (function (e, t, n) {
      ...
      return r(t, "string") || r(t, "undefined")
        ...
        : (function e(t, i, o) {
            for (var s in t) {
              var a = i[t[s]];
              if (a !== n)
                return !1 === o ? t[s] : r(a, "function") ? a.bind(o || i) : a;
            }
            return !1;
      ...
      k = function (e, n, i, r) {
        ...
        return (
          ...
          u
            ...
            : (d.parentNode.removeChild(d), (f.style.overflow = l)),
          !!s
        );
      },
      S = function (t) {
      ...
      return (
        i(
          (
            ...
            y.join("linear-gradient(left top,#9f9, white);" + e)
          ).slice(0, -e.length),
        ),
    ...
    (C.svg = function () {
      return (
        !!t.createElementNS && !!t.createElementNS(x.svg, "svg").createSVGRect
      );
    }),
    ...
    (C.smil = function () {
      return (
        !!t.createElementNS &&
        /SVGAnimate/.test(v.call(t.createElementNS(x.svg, "animate")))
      );
    }),
    (C.svgclippaths = function () {
      return (
        !!t.createElementNS &&
        /SVGClipPath/.test(v.call(t.createElementNS(x.svg, "clipPath")))
      );
    }),
    C))
      u(C, j) &&
        ((d[(c = j.toLowerCase())] = C[j]()), A.push((d[c] ? "" : "no-") + c));
    return (
      d.input ||
        ((d.input = (function (n) {
          ...
          for (var i, r, o, s = 0, a = e.length; s < a; s++)
            (m.setAttribute("type", (r = e[s])),
              (i = "text" !== m.type) &&
                ...
                /^range$/.test(r) && m.style.WebkitAppearance !== n
                  ? (f.appendChild(m),
                    (i =
          ...
          return (
            !p.shivCSS ||
              ...
              (f.hasCSS =
                ...
                !!c.insertBefore(l.lastChild, c.firstChild))),
            a ||
              ((u = e),
              (d = f).cache ||
                ((d.cache = {}),
                (d.createElem = u.createElement),
                (d.createFrag = u.createDocumentFragment),
                (d.frag = d.createFrag())),
          ...
          ? (function e(n, i, r, o, l, c, u) {
              function f(e) {
                if (
                  ...
                  T[i]))
                    T[i].hasOwnProperty(t) && T[i][t].onload();
              }
              var u = u || d.errorTimeout,
                g = t.createElement(n),
                y = 0,
                w = 0,
                x = { t: r, s: i, e: l, a: c, x: u };
              (1 === T[i] && ((w = 1), (T[i] = [])),
                "object" == n ? (g.data = i) : ((g.src = i), (g.type = n)),
                (g.width = g.height = "0"),
                (g.onerror =
                  g.onload =
                ...
                "img" != n &&
                  (w || 2 === T[i]
                    ? ($.insertBefore(g, b ? null : p), h(f, u))
                    : T[i].push(g)));
            })("c" == n ? x : w, e, n, this.i++, i, o, l)
        ...
        ((n = c ? a : n || o),
          (g.onreadystatechange = g.onload =
            function () {
              !u &&
                s(g.readyState) &&
                ((u = 1), n(), (g.onload = g.onreadystatechange = null));
            }),
          h(function () {
            u || ((u = 1), n(1));
          }, r),
