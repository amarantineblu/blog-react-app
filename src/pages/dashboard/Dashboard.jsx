                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5 col-md-6 col-sm-12">
                            <ul className="breadcrumb float-md-right">
                                ...
                                <li className="breadcrumb-item active">Jquery DataTables</li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="card">
                                <div className="header">
                                    ...
                                    <ul className="header-dropdown">
                                        <li className="dropdown"> <a href="/" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i className="zmdi zmdi-more"></i> </a>
                            ...
                            <div className="card">
                                <div className="header">
                                    ...
                                    <ul className="header-dropdown">
                                        ...
                                        <li className="remove">
                                            <div role="button" className="boxs-close"><i className="zmdi zmdi-close"></i></div>
                                        </li>
                                    </ul>
                                </div>
                                <div className="body">
